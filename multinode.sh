...
echo -e "Preparing the VPS to setup. ${CYAN}$COIN_NAME${NC} ${YELLOW}Masternode Multinode System${NC}"
...
\t *****************************\n"
 ...
 echo -e "Use:    ${RED}$COIN_CLI getinfo${NC} to check your Wallet Status."
 echo -e "VPS_IP: ${GREEN}$NODEIP:$COIN_PORT${NC}"
 echo 
 echo -e "${YELLOW}Add info to Activemasternode config file ${NC}"
 echo -e "Format:  ${GREEN}alias activemasternodeprivkey${NC}"
 echo -e "Example: ${GREEN}mn1 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg${NC}"
 echo -e "Use: ${RED}echo alias activemasternodeprivkey >> .flits/activemasternode.conf${NC}"
 echo 
 }
